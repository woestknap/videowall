...
function Layer({ layer }: { layer: SceneLayer }) {
  ...
  const typography = { fontFamily: layer.content.fontFamily, fontSize: layer.content.fontSize ? `${layer.content.fontSize}px` : undefined }
